...
files = [
    "./DataSet/art_coverage_by_country_clean.csv",
    "./DataSet/art_pediatric_coverage_by_country_clean.csv",
    "./DataSet/no_of_cases_adults_15_to_49_by_country_clean.csv",
    "./DataSet/no_of_deaths_by_country_clean.csv",
    "./DataSet/no_of_people_living_with_hiv_by_country_clean.csv",
...
def extract_countries_regions(file_path):
    try:
        ...
        if country_col and region_col:
            ...
            print(f"⚠️ Aucune colonne 'Country' trouvée dans `{file_path}` !")
...
try:
    ...
    output_file = "./Csv2Table/pays_clean2.csv"
