...
try:
    ...
    mortalite_df["taux_mortalite"] = pd.to_numeric(mortalite_df["taux_mortalite"], errors="coerce")

    mortalite_df.dropna(inplace=True)

    mortalite_df["taux_mortalite"] = mortalite_df["taux_mortalite"].astype(int)
    ...
    print(f"📊 Nombre de pays avec statistiques : {len(mortalite_df)}")
